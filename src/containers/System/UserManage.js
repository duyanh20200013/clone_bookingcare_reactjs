                            ...
                            <tr>
                                ...
                                { arrUsers && arrUsers.map((item,index)=>{
                                    return(
                                        ...
                                        <td>{item.address}</td>
                                        <td>
                                            <button className="btn-edit" onClick={()=>{this.handleEditUser(item)}}><i className="fa fa-pencil-alt"></i></button>
